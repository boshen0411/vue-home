<template>
    <div v-loading="scenesLoading">
        ...
        >
            ...
            <span label="抓拍照片" width="100">
                <template scope="idx">
                    <figure style="width:40px;height:40px"><img :src="img_url + snap.list[idx].capPicture || img" @error="defaultImg" style="height:100%;width:100%;object-fit: contain;"></figure>
                </template>
            </span>
